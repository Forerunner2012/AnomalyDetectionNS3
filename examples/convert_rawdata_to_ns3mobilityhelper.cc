...
{
    NS_LOG_UNCOND ("Tool for converting *rawdata (Madrid dataset)* to *ns2 HelperMobility Format*");
    ...
    cout << "Number of nodes detected: " << n_nodes << " (add 1 more node to use trace since node0 is not used: " << n_nodes+1 << ")" << endl;
